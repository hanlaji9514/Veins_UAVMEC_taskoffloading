...
#include <veins/modules/application/traci/CoCaCo/CoCaCoRSU.h>
...
Define_Module(veins::CoCaCoRSU);

void CoCaCoRSU::initialize(int stage)
{
...
CoCaCoRSU::CoCaCoRSU() : RSU_resource(10000,10000) {} // 讓每一個RSU都有其獨立的RSU_resource

void CoCaCoRSU::onWSA(DemoServiceAdvertisment* wsa)
{
...
void CoCaCoRSU::onWSM(BaseFrame1609_4* frame)
{
...
void CoCaCoRSU::onBM(BeaconMessage* bsm)
{
...
void CoCaCoRSU::handleReceivedTask()
{
...
void CoCaCoRSU::handlePositionUpdate(cObject* obj)
{
