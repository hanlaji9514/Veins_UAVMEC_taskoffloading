...
#include <veins/modules/application/traci/GHDSF/GHDSFRSU.h>
...
Define_Module(veins::GHDSFRSU);


void GHDSFRSU::initialize(int stage)
{
    ...
    if (stage == 0) {
        ...
        cMessage *checkcarMsg = new cMessage("check_resource");
...
GHDSFRSU::GHDSFRSU() : RSU_resource(10000,10000) {} // 讓每一個RSU都有其獨立的RSU_resource

void GHDSFRSU::onWSA(DemoServiceAdvertisment* wsa)
{
...
void GHDSFRSU::onWSM(BaseFrame1609_4* frame)
{
...
void GHDSFRSU::onBM(BeaconMessage* bsm)
{
...
void GHDSFRSU::handleSelfMsg(cMessage* msg)
{
...
void GHDSFRSU::handleReceivedTask()
{
...
void GHDSFRSU::handlePositionUpdate(cObject* obj)
{
